    ...
    do
        ...
        do
            ...
            if [ $tp -eq 1 ]; then
                ...
                python3 $tool_latency --model $model --batch-size $bat -tp $tp --input-len $inp --output-len $out --num-iters-warmup $n_warm --num-iters $n_itr --trust-remote-code --dtype $dtype --output-json $outjson
            fi
        ...
        do
            ...
            do
                ...
                if [ $tp -eq 1 ]; then
                    ...
                    python3 $tool_throughput --model $model --num-prompts $req -tp $tp --input-len $inp --output-len $out --trust-remote-code --dtype $dtype --output-json $outjson
                fi
